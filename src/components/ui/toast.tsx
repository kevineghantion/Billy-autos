...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Title ref={ref} className={cn("text-sm font-display font-bold tracking-wide text-primary", className)} {...props} />
));
